...
:::{dropdown} **Access to Services** Python Code
...
:::{dropdown} **Facilities** Python Code
```python
import argparse
import os
import sys
...
:::{dropdown} **Coping Capacity** Python Code
```python
import os
import pandas as pd
from pathlib import Path
...
:::{dropdown} **Demographics** Python Code
```python
import os
import sys
from typing import List
...
:::{dropdown} **Rural Population** Python Code
```python
import os
import shutil
import zipfile
...
:::{dropdown} **Vulnerability** Python Code
```python
import os
import pandas as pd
from pathlib import Path
...
:::{dropdown} **Crop Coverage and Change** Python Code
```python
import os
import geopandas as gpd
import pandas as pd
...
:::{dropdown} **Vegetation Index** Python Code
```python
import geopandas as gpd
import geemap
import ee
