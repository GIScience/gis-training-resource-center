...
| ----------- | ---------------------------- |
| __[Capítulo 1: Teoría de la automatización](/content/es/Module_7/es_qgis_automation_theory.md)__ | Al final de este capítulo, usted debe saber el valor de la reproducibilidad en el análisis de datos, saber cómo utilizar el constructor de modelos en QGIS |
| __[Ejercicio 1: Automatización](/content/es/Module_7/es_qgis_module_7_ex1.md)__ | |
