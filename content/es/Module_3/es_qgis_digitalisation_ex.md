...
* [Digitalización](../Wiki/es_qgis_digitisation_wiki.md)
* [Mapas base](../Wiki/es_qgis_basemaps_wiki.md)
...
:::{Attention}
Intente utilizar siempre la estructura de carpetas estándar. Puede encontrar una plantilla __[aquí](../Wiki/es_qgis_projects_folder_structure_wiki.md)__.
:::
...
Organice la capa en `Panel de capas` de forma que el OSM esté en la parte inferior ([video en Wiki](../Wiki/es_qgis_basemaps_wiki.md))
...
Para ello, tendremos que crear una nueva capa de puntos:
    1. Haga clic en `Capa` → `Crear Capa` → `Nueva capa GeoPackage`([video en Wiki](../Wiki/es_qgis_digitisation_wiki.md)).
...
4. Ahora puede crear un punto para cada uno de los tres bancos de la zona [Wiki](../Wiki/es_qgis_digitisation_wiki.md). Actualmente el nuevo “Abuja_bank_point” está vacío. Para añadir entidades podemos utilizar la barra de herramientas `Digitalización`. Si no puede ver la barra de herramientas `Ver` → `Barras de herramientas` y compruebe `Digitalización` ([video de Wiki](../Wiki/es_qgis_digitisation_wiki.md)). ![](../../../fig/Digitizing_Toolbar.png)
...
1. Para ello necesitamos de nuevo una nueva capa. En este caso, una capa de polígonos. La creación es básicamente la misma que para el punto.
    1. Haga clic en `Capa` → `Crear Capa` → `Nueva capa GeoPackage`([Wiki](../Wiki/es_qgis_digitisation_wiki.md)).
...
2. Para digitalizar esta zona, haga clic en la nueva capa “Abuja_roadblock_polygon” ([Wiki: Digitalización de polígonos](../Wiki/es_qgis_digitisation_wiki.md)).
...
1. Para ello necesitamos de nuevo una nueva capa. En este caso, una capa de línea. Su proceso de creación es casi el mismo que el de punto.
    - Haga clic en `Capa` → `Crear Capa` → `Nueva capa GeoPackage`([Wiki](../Wiki/es_qgis_digitisation_wiki.md)).
    ...
    - En `Nuevo campo` puede añadir columnas a la nueva capa. Añada la columna “Road_type”.
        ...
        * Haga clic en `Aceptar`.
            ...
            :::
    * La nueva capa aparecerá en `Panel de capas`.
2. Seleccione la capa de línea “Abuja_bank_road_connection_line” para añadir datos en el panel Layer [Wiki: Añadir datos de linea](../Wiki/es_qgis_digitisation_wiki.md).
