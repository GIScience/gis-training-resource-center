...
* [Georreferenciación](es_qgis_georeferencing.md)
:::
...
1. Agregue un mapa base usando XYZ Tiles o el [complemento QuickMapServices](../Wiki/es_qgis_basemaps_wiki.md).
...
21. Cree una nueva capa shapefile (consulte [digitalización](es_qgis_digitisation.md)). Haga clic en `Capa` → `Crear capa` → `Nueva capa de archivo Shape...` (también puede optar por crear una nueva capa GeoPackage).
