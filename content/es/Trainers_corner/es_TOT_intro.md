...
```{admonition} Contacta al equipo de la Plataforma de Capacitación en SIG de la IFRC
...
➕ Consejos y orientación sobre cómo planificar y enseñar una capacitación en SIG.  
➕ Herramientas para evaluar las habilidades en SIG de los participantes antes y después de la capacitación.  
...
- El artículo [Cómo planificar una capacitación en SIG](es_how_to_training.md) proporciona una lista de verificación de aspectos a considerar al planificar una capacitación. Además, incluye una lista de contenidos esenciales para una capacitación básica en SIG, ayudando a los formadores a seleccionar ejercicios adecuados para su audiencia.
- [Agenda de capacitación y material de apoyo](es_training_graphical_outline.md) ofrece ideas sobre diferentes métodos para comunicar información administrativa de manera eficiente a los participantes. Esto puede ir desde una simple tabla en un correo electrónico hasta un tablero más elaborado en Miro.
- [Cómo planificar y estructurar una sesión de capacitación en SIG](es_training_day_structure.md) aborda estrategias detalladas para estructurar sesiones de capacitación, especialmente útiles para formadores principiantes que buscan ganar confianza al impartirlas.
- [Cómo enseñar SIG](es_how_to_teach_GIS.md) reúne buenas prácticas, consejos y experiencias en la enseñanza de SIG, ofreciendo ideas y estrategias valiosas para que los formadores mejoren sus métodos de enseñanza.
- [Evaluacion de la capacitación en SIG: una guía](es_how_to_assessment.md) presenta las herramientas disponibles en esta plataforma para evaluar el nivel de habilidad en SIG de los participantes antes y después de las sesiones de capacitación.
