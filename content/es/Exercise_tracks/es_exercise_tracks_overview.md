...
También hemos preparado una serie de ejercicios, que cubren las competencias del módulo 1 al 5. Estos ejercicios suelen ser un poco más largos y requieren más tiempo.
...
- [Respuesta a la inundación de Larkana](/content/es/Exercise_tracks/es_larkana_flood_response.md)
- [Análisis de acción anticipatoria para ciclones en Madagascar](/content/es/Exercise_tracks/es_mdg_aa_cyclones.md)
