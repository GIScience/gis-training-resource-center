...
Make sure you installed the ORS Tools plugin and set it up already with an API Key. If not - click here [Plugin: OpenRouteService (ORS) Tools] (https://giscience.github.io/gis-training-resource-center/content/Modul_9/en_qgis_openrouteservice_tools.html)
