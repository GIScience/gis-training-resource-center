# Assessments in GIS Training: A Guide <a id="assessments-in-gis-training-a-guide"></a>
...
## Survey templates <a id="survey-templates"></a>


```{card} Google survey template: Pre Training Survey
...
```{card} Kobo survey template: Pre Training Survey
...
## Why do we do assessments? <a id="why-do-we-do-assessments"></a>
...
## Introduction to the standard survey <a id="introduction-to-the-standard-survey"></a>
...
### Acquired competence <a id="acquired-competence"></a>
...
### Motivation <a id="motivation-2"></a>
