...
# Operational Maps Tutorials <a id="operational-maps-tutorials"></a>
...
## 3W Map (Who, What, Where) <a id="3w-map-who-what-where"></a>
...
### Getting the 3W required data <a id="getting-the-3w-required-data"></a>
...
### 3W Map Creation <a id="3w-map-creation"></a>
...
### About the Dataset <a id="about-the-dataset-2"></a>
...
#### Fields used in this tutorial <a id="fields-used-in-this-tutorial-2"></a>


| **Field**                 | **Contents** |
|--------------------------|--------------------------|
| **weekX_inf_new**         | Count of new weekly infections in week X of the outbreak |
| **weekX_inf_cul**          | Cumulative count of infections in week X |
| **weekX_dc**          | Count of weekly deaths in week X|
...
#### Data preparation <a id="data-preparation-2"></a>
...
### Creating a map visualising weekly infections and infection trends <a id="creating-a-map-visualising-weekly-infections-and-infection-trends"></a>
...
:::{Tip}
With the layer styling variable **"Size from ... to ..."** you can alter the size interval the points will cover to display the values. Try differnet options and choose which combination communicates the values optimally for you purpose. A good default for this visualization is 5 to 15 millimeters.
:::
::::
...
### Display the current infection trend with polygon colours <a id="display-the-current-infection-trend-with-polygon-colours"></a>
...
### Creating a map visualising weekly deaths and mortality rate <a id="creating-a-map-visualising-weekly-deaths-and-mortality-rate"></a>
...
#### Create circles proportional to weekly infections <a id="create-circles-proportional-to-weekly-infections"></a>
...
#### Display the current mortality rate with polygon colours <a id="display-the-current-mortality-rate-with-polygon-colours"></a>
...
2. **Create a new field diplaying infection trend**
   - In the Field Calculator interface keep "Create a new field" selected and choose "mortality_rate" as "Output field name". As "Output field type" choose **"Decimal number (real)"**
   - In the "Expression panel" enter the following code chunk:
