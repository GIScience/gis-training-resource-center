...
- __Folder Structure:__ Ensure that exercise data follows the [correct folder structure](Wiki/en_qgis_projects_folder_structure_wiki.md#standard-folder-structure) and is zipped correctly (avoid excessive folder nesting as this can lead to problems when unzipping)
