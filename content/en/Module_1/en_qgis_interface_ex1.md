...
- [Projects and folder structure](../Wiki/en_qgis_projects_folder_structure_wiki.md)
...
On the right of the screen, you will most likely have the __Processing Toolbox__ panel. If it is missing for you, check out this [wiki page](../Wiki/en_qgis_common_errors_and_Issues.md#missing-toolbox).
