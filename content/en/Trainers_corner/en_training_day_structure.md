...
13. __Ask for feedback:__ Gather quick feedback, enabling adjustments to training content, style, and pacing based on participant input.
...
3. __Recap of the last session:__ Briefly summarize what was covered in the previous session. Address any questions or concerns raised by the participants. If there was homework assigned, allow the participants to present their completed assignments.
...
4. **Outlook:** Provide guidance on the way forward. Answer common questions such as whether there will be additional training sessions and how participants can further develop their GIS skills. You can always refer them to the training platform for additional resources.

5. **Contact information:** Ensure that participants know how to contact you after the training. Additionally, consider compiling a list of participants’ contact details to facilitate networking, with their consent, of course.

6. **Farewell:** Finally, close the training session with a farewell, wishing everyone all the best in their future endeavors.
