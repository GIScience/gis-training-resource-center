...
21. Create a new shapefile layer (see [digitisation](en_qgis_digitisation.md#creating-new-datasets)). Click on `Layer` → `Create Layer` → `Create new Shapefile Layer` (You can also choose to create a new Geopackage Layer).
