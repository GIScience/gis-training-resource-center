...
The folder is called “Module_3_Exercise_1_Flood_Nigeria" and contains the entire [standard folder structure](../Wiki/en_qgis_projects_folder_structure_wiki.md#standard-folder-structure) with all data in the input folder and the additional documentation in the documentation folder.
...
17. This will be a problem as soon as we do something different then just displaying the layers. Since we want to manipulate the layers in the next step we need to reproject them first ([Wiki Video](../Wiki/en_qgis_projections_wiki.md#changing-the-projection-of-a-vector-layer)). 
