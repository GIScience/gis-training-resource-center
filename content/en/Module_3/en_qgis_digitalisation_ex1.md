...
:::{Attention}
Try to always use the standard folder structure. You can find a template [__here__](../Wiki/en_qgis_projects_folder_structure_wiki.md#standard-folder-structure).
:::
