...
1. First, we need to create a new print layout:
    ...
    - A new window will open, this is the [print layout composer](en_qgis_map_design_2.md). Take the time to  [understand the interface and the different tools](en_qgis_understanding_print_layout.md).
