...
1. In the [processing toolbox](../Module_1/en_qgis_start.md#toolbox-toolbars), search for the tool `centroids`. <kbd>Double-Click</kbd> on it. A new window will open (see {numref}`en_3.36_m4_centroids`).
...
- [Cartography Guide](https://www.axismaps.com/guide) by [Axis Maps](https://axismaps.com)
