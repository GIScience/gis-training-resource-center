...
:::{Tip}
If the plugin is installed and activated but the panel is not visible check Wiki [Move and arrange toolbars and panels](../Wiki/en_qgis_interface_wiki.md#show-and-hide-displays-and-toolbars)
:::
