# Sketch Map Tool Exercise 6 - Reservior Water Level monitoring with OpenAerialMap (fictional)
...
### 2. Data Collection <a id="1-data-collection"></a>



Please download the prepared maps [here](https://nexus.heigit.org/repository/gis-training-resource-center/mobile_data_collection/sketch_map_tool_training/Sketch_Map_Tool\_Exercise_6.zip).
...
#### Geo-referencing and auto-extraction with the Sketch Map tool <a id="2-geo-referencing-and-auto-extraction-with-the-sketch-map-tool"></a>
...
The sketch maps are now being processed and georeferenced with the annotations extracted and vectorized. Download or use prepared vector data in the input data folder: `\Sketch_Map_Tool_Exercise_4\data\output\SMT_Ex6_dig.geojson`.
...
### 4. Explore the data <a id="3-explore-the-data"></a>
...
Normally, you know the meaning of the markings in your Sketch Map. We will now learn how to add them to your vector layer. In our example, we assume we know that blue were used to mark water surface polygons, green agriculture polygons, new path polygons between water source and agriculture red, broken pump points red, disconnected water intake pump points black. We want to replicate this:
