...
# Introduction to geodata and layers <a id="introduction-to-geodata-and-layers"></a>
...
## What is geodata? <a id="what-is-geodata"></a>
...
#### Vector file formats <a id="vector-file-formats"></a>
...
#### Shapefile structure <a id="shapefile-structure"></a>
...
#### Raster data formats <a id="raster-data-formats"></a>
...
## The layer concept <a id="the-layer-concept"></a>
...
:link: en_qgis_geodata_concept_ex1.md
...
#### Open vector data via the Data Source Manager <a id="open-vector-data-via-the-data-source-manager"></a>
...
#### Open Delimited Text Layer <a id="open-delimited-text-layer"></a>
