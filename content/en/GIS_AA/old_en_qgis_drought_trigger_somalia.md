<!--THIS IS THE OLD DOCUMENTATION PRIOR TO MARCH 2025-->
...
To fix these issues, take a look at the subsection on [Troubleshooting the model](en_qgis_drought_trigger_somalia.md#troubleshooting-the-model).
...
- Furthermore, the values for the [different food insecurity phase](en_qgis_drought_trigger_somalia.md#what-is-ipc-food-security-projection-data) (1 to 5: Minimal, Stressed, Crisis, Emergency, Famine) are no longer in a column called "ML1" and "ML2" respectively, but in a column with the name __"value"__.
