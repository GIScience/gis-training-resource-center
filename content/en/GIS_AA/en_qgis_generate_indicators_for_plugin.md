...
To conduct a meaningful risk assessment with the [Risk Assessment QGIS Plugin](en_qgis_risk_assessment_plugin.md), it is essential to prepare input indicator files that represent the three main dimensions:
