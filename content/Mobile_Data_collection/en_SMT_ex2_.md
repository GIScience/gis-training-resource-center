...
- There are in total 5 Case studies avalable which each contain 2 Sketch Maps (one based on OSM, one on satellite imagery) and the respective Quality Report
