...
# The model designer in QGIS <a id="the-model-designer-in-qgis"></a>

## Introduction into the QGIS Model Designer <a id="introduction-into-the-qgis-model-designer"></a>
...
### Creating a model <a id="creating-a-model"></a>
...
#### Building a model to buffer road infrastructure <a id="building-a-model-to-buffer-road-infrastructure"></a>
...
#### Selection of inputs <a id="selection-of-inputs"></a>
...
#### Selecting the Algorithms <a id="selecting-the-algorithms"></a>
...
#### Chaining algorithms <a id="chaining-algorithms"></a>
...
### Tips and Tricks when working in the model designer <a id="tips-and-tricks-when-working-in-the-model-designer"></a>
